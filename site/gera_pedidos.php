...
<hr align="center"></td>
  ...
  <tr> 
    <td class="titulos"><div align="center"><strong><font size="7"><strong><font color="#00CC99" size="5">JOÃO 
        ...
        para o Dia </font><font color="#ffffff" size="4" face="Verdana, Arial, Helvetica, sans-serif">:</font><font color="#ffffff" size="3" face="Verdana, Arial, Helvetica, sans-serif"> 
...
<div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><br>
  DESMARQUE os Clientes que PEDIRAM Refeição</strong></font><br>
  <?
...
$insere_data_pedido="UPDATE tabela_temp SET data_pedido='$dados'";
...
while ($row=mysql_fetch_array($resultado) ) {
	...
	if ($tipo_pagto=="Sim")	{
		...
		while ($linha=mysql_fetch_array($tipo_pagto_resultante) ) {
			...
			$insere_valor="UPDATE tabela_temp SET valor_visa_vale='$valor'*quantidade WHERE visa_vale='Sim'";
		...
		while ($linha=mysql_fetch_array($tipo_pagto_resultante) ) {
			...
			$insere_valor="UPDATE tabela_temp SET valor_ref='$valor'*quantidade WHERE visa_vale='Não'";
			mysql_query($insere_valor, $conn);
		}
	}
}
...
while ($row=mysql_fetch_array($sql) ) {
	$valor=$row["preco_ref"];
	$insere_valor="UPDATE tabela_temp SET preco_refeicao='$valor' WHERE data_pedido='$dados'";
	mysql_query($insere_valor, $conn);
}
...
while ($row=mysql_fetch_array($sql) ) {
	...
	$insere_valor="UPDATE tabela_temp SET preco_vale='$valor' WHERE data_pedido='$dados'";
	mysql_query($insere_valor, $conn);
}

$query_rs_produtos = "SELECT * FROM tabela_temp ORDER BY local, horario, andar DESC, sala";
...
<form action="excluir_pedidos.php" method="POST">
  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#cccccc">
    <tr> 
      <td align="center" bgcolor="#ffffff"><b>Nome</b></font></td>
      <td align="center" bgcolor="#ffffff"><b>Local</b></font></td>
	  <td align="center" bgcolor="#ffffff"><b>Hora</b></font></td>
      <td align="center" bgcolor="#ffffff"><b>Andar</b></font></td>
      <td align="center" bgcolor="#ffffff"><b>Sala</b></font></td>
      <td align="center" bgcolor="#ffffff"><b>Telefone</b></font></td>
      <td align="center" bgcolor="#ffffff"><b>Sal</b></font></td>
      <td align="center" bgcolor="#ffffff"><b>Quant</b></font></td>	  
      <td align="left" bgcolor="#ffffff"><b>Observações/Predileções</b></font></td>
      <td align="center" bgcolor="#ffffff"><b>Não Pediu</b></font></td>
    </tr>
    <? do { ?>
    <tr> 
  ...
  <table width="100%" border="0" align="center" bgcolor="#cccccc">
    ...
    <tr> 
      <td colspan="4"><div align="center"> 
          <input name="gerar_pedidos" type="submit" value="GERAR PEDIDOS" />
        </div></td>
    </tr>
    <tr> 
      <td colspan="4">&nbsp;</td>
