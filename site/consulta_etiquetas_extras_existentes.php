...
<table width="80%" bgcolor="#cccccc" border="0" align="center">
  ...
  <tr> 
    <td class="titulos"><div align="center"><strong><font face="Verdana" size="5" color="#00CC99">JOÃO 
        ...
        <strong><font face="Verdana, Arial, Helvetica, sans-serif" size="4" color="#FFFFFF">Emissão 
        de Etiquetas Extras de Pedidos</font></strong><br>
        <font color="#FFFFFF" size="4"><strong>(Clientes com mais de 1 refeição)</strong></font><br>
      </div></td>
  </tr>
  <tr> 
...
<table width="80%" border="0" bgcolor="#CCCCCC" align="center">
  ...
  <tr> 
    <td> <div align="center">
        <p>&nbsp;</p>
		<form name="form1" method="post" action="gera_etiquetas_extras.php" onSubmit="return valida_campo(this)"><div align="center"> 
          <p> 
