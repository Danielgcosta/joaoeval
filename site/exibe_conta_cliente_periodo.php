...
<?
$dados=$_POST;
list($nome, $data_entrada1, $data_entrada2)=array_values($dados);
...
<br>
<br>
<p><font size="2" face="Arial, Helvetica, sans-serif">Pagamento atrav&eacute;s 
  de tranfer&ecirc;ncia ou dep&oacute;sito banc&aacute;rio:</font></p>
<table width="94%">
  <tr> 
    <td width="49%" bgcolor="#CCCCCC"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Banco 
      ITA&Uacute;</strong><br>
      <strong>Ag&ecirc;ncia</strong>: 6158 - <strong>C/C</strong>: 33854-8<br>
      <strong>Nome</strong>: JOÃO Mello da Costa J&uacute;nior<br>
      <strong>CPF</strong>: 665.755.757-49<strong></strong></font></td>
    <td width="51%" valign="top" bgcolor="#CCCCCC"><font size="2" face="Arial, Helvetica, sans-serif"><strong>IMPORTANTE:<br>
      Favor acrescentar ____ centavos para a identificação<br>
      do seu dep&oacute;sito.</strong></font></td>
  </tr>
</table>
<br>
<table width="100%" border="0">
  <tr> 
    ...
    <td width="50%"><form name="form2" method="get" action="consulta_conta_cliente_periodo.php">
