...
<hr align="center"></td>
  ...
  <tr> 
    <td class="titulos"><div align="center"><strong><font size="7"><strong><font color="#00CC99" size="5">JOÃO 
        ...
        <br>
        <font color="#FFFFFF" size="4" face="Verdana, Arial, Helvetica, sans-serif">Inclusão 
...
while ($row=mysql_fetch_array($resultado) ) {
	...
	if ($tipo_pagto=="Sim")	{
		...
		while ($linha=mysql_fetch_array($tipo_pagto_resultante) ) {
			...
			$insere_valor="UPDATE tabela_temp_inclusao SET valor_ref='$valor'*quantidade WHERE visa_vale='Não'";
			mysql_query($insere_valor, $conn);
		}
	}
}
...
<form action="excluir_pedidos_inclusao.php" method="POST">
  <table width="100%" border="1" bgcolor="#cccccc" cellspacing="0" cellpadding="1">
    <tr> 
      ...
      <td align="left" bgcolor="#ffffff"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>Observações/Predileções</font></td>
      <td align="center" bgcolor="#ffffff"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>Não Pediu</font></td>
    </tr>
    <? do { ?>
    <tr> 
