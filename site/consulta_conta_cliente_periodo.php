...
<table width="80%" bgcolor="#cccccc" border="0" align="center">
  ...
  <tr> 
    <td class="titulos"><div align="center"><strong><font face="Verdana" size="5" color="#00CC99">JOÃO 
        ...
        Conta do Cliente por Per&iacute;odo</font></strong><br>
      </div></td>
  </tr>
  <tr> 
...
<table width="80%" border="0" bgcolor="#CCCCCC" align="center">
  <tr> 
    <td colspan="2"><form name="form1" method="post" action="exibe_conta_cliente_periodo.php" onSubmit="return valida_campo(this)"><div align="center"> 
...
?>
          ...
          <select name="data_entrada2" id="select">
  ...
  <tr> 
    <td width="78%" align=center><br> <br> 
    <td width="22%" align=center><form name="form2" method="get" action="operacoes_pedidos.php">
