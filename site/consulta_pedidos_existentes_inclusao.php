...
<table width="80%" bgcolor="#cccccc" border="0" align="center">
  ...
  <tr> 
    <td class="titulos"><div align="center"><strong><font face="Verdana" size="5" color="#00CC99">JOÃO 
        ...
        <strong><font face="Verdana, Arial, Helvetica, sans-serif" size="4" color="#FFFFFF">Inclusão 
        de Clientes em um Pedido</font></strong> <br>
      </div></td>
  </tr>
  <tr> 
...
<table width="80%" border="0" bgcolor="#CCCCCC" align="center">
  ...
  <tr> 
    <td> <div align="center">
        <p>&nbsp;</p>
		<form name="form1" method="post" action="gera_pedidos_inclusao.php" onSubmit="return valida_campo(this)"><div align="center"> 
          <p> 
  ...
  <tr>
    <td><div align="center"> 
        <form name="form2" method="get" action="administracao.php">
